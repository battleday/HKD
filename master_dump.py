...
diff --git a/test50k_images.npy b/test50k_images.npy
new file mode 100644
index 0000000..2ccd076
Binary files /dev/null and b/test50k_images.npy differ
diff --git a/test50k_labels.npy b/test50k_labels.npy
new file mode 100644
index 0000000..9b781d2
Binary files /dev/null and b/test50k_labels.npy differ
diff --git a/train.py b/train.py
new file mode 100644
index 0000000..d485514
--- /dev/null
+++ b/train.py
@@ -0,0 +1,341 @@
+import os
...
\ No newline at end of file
diff --git a/train10k_images.npy b/train10k_images.npy
new file mode 100644
index 0000000..7572a2b
Binary files /dev/null and b/train10k_images.npy differ
diff --git a/train10k_labels.npy b/train10k_labels.npy
new file mode 100644
index 0000000..e28ed34
Binary files /dev/null and b/train10k_labels.npy differ
diff --git a/train_manager.py b/train_manager.py
new file mode 100644
...
+	os.fsync(logs.fileno())
\ No newline at end of file
diff --git a/wrn.py b/wrn.py
new file mode 100644
index 0000000..90b501d
--- /dev/null
+++ b/wrn.py
@@ -0,0 +1,172 @@
+import torch
