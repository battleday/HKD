...
# cinic_directory = '/mnt/bucket/people/smondal/Teacher-Assistant-Knowledge-Distillation/DS_10283_3192/cinic_10_imagenet_new/'
...
class cifar_softhard(Dataset):
	...
	def __init__(self,train=True):
		...
		if train:
			...
			# file1 = 'test_imagenetfar_images.npy'
			# file2 ='test_imagenetfar_labels.npy'
			# file3= 'test_imagenetfar_labels.npy'
...
def get_cinic(num_classes=100, dataset_dir='./data', batch_size=1, crop=False):
    ...
    batch_size=batch_size, pin_memory = True, shuffle=False,num_workers=NUM_WORKERS)
